...
int DlugoscCiagu()
{
    ...
    else
    {
        ...
        while (plik >> liczba)
        {
            ...
            {
                if (liczba[i] == '1') liczba_jedynek++;
                else liczba_zer++;
            }
            if (liczba_zer > liczba_jedynek)licznik++;
            liczba_jedynek = 0;
            liczba_zer = 0;
        }
        cout << licznik << endl;
...
int main2()
{
    ...
    else
    {
        ...
        while (plik >> liczba2)
        {
            if (liczba2[liczba2.length() - 1] == '0')przez_2++;
            if (liczba2[liczba2.length() - 1] == '0' && liczba2[liczba2.length() - 2] == '0' && liczba2[liczba2.length() - 3] == '0')przez_8++;
        }
        cout << przez_2 << endl << przez_8 << endl;
    }
    return 0;
}
int sprawdzanie()
{
    ...
    unsigned int a;
    cout << "Napisz tekst do sprawdzenia:" << endl;
    getline(cin, tekt);
    for (a = 0;a < tekst.size();a++)
    {
        if (tekst[a] > 'z' < || tekst[a] < 'a')
        {
            male_litery = false;
        }
    }
    if (male_litery == true)
    {
        cout << "Tak! Tekst sklada sie z tylko malych liter alfabetu lacinskiego" << endl;
    }
    else
    {
        cout << "Nie! Tekst nie sklada sie z tylko malych liter alfabetu lacinskiego" << endl;
    }
    return 0;
}
int main()
